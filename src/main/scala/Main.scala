...
object Main {
  def main(args: Array[String]): Unit = {
    println(s"Day1: Captcha -> ${Day01.Part1.captcha(Day01.in)}")
    println(s"Day1: Captcha2 -> ${Day01.Part2.captcha(Day01.in)}")
    ...
    println(s"Day4: CountValid2 -> ${Day04.Part2.countValid(Day04.in)}")
