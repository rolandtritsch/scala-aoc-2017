...
object Main {
  def main(args: Array[String]): Unit = {
    ...
    println(s"Day06: DetectLoops -> ${Day06.Part1.detectLoop(Day06.in)._1}")
    println(s"Day06: DetectLoops2 -> ${Day06.Part1.detectLoop(Day06.in)._2}")
    println(s"Day07: FindRoot -> ${Day07.Tree.findRoot(Day07.parseInput(Day07.in))}")
    println(s"Day07: FindBadNode -> ${Day07.Tree.solve(Day07.in)._1}")
